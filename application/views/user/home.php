            ...
            <div class="container page__heading-container">
                <div class="page__heading d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h1 class="m-0"><?=$this->session->userdata('username')?></h1>
                        <p class="text-muted m-0">Calon <?=$this->session->userdata('level')?></p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            <div class="border-bottom">
                                ...
                                <div class="card-body text-center">
                                    <div class="mb-3">
                                        <img src="<?=base_url()?>assets/images/256_luke-porter-261779-unsplash.jpg" alt="About Adrian" width="100" class="rounded-circle">
                                    </div>
